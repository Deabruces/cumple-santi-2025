    ...
    <div className='bg-black border-4 border-green-500 p-6 gaming-glow-strong relative'>
      ...
      <div className='grid grid-cols-4 gap-2 md:gap-3 mb-4'>
        <div className='bg-black border-2 border-green-500 p-2 md:p-3 text-center'>
          ...
          <div className='text-[0.6rem] md:text-xs text-green-300 pixel-text mt-1'>DÍAS</div>
        </div>
        <div className='bg-black border-2 border-green-500 p-2 md:p-3 text-center'>
          <div className='text-2xl md:text-4xl font-bold text-green-400 pixel-heading'>
            {timeLeft.hours}
          </div>
          <div className='text-[0.6rem] md:text-xs text-green-300 pixel-text mt-1'>HRS</div>
        </div>
        <div className='bg-black border-2 border-green-500 p-2 md:p-3 text-center'>
          <div className='text-2xl md:text-4xl font-bold text-green-400 pixel-heading'>
            {timeLeft.minutes}
          </div>
          <div className='text-[0.6rem] md:text-xs text-green-300 pixel-text mt-1'>MIN</div>
        </div>
        <div className='bg-black border-2 border-green-500 p-2 md:p-3 text-center'>
          <div className='text-2xl md:text-4xl font-bold text-green-400 pixel-heading'>
            {timeLeft.seconds}
          </div>
          <div className='text-[0.6rem] md:text-xs text-green-300 pixel-text mt-1'>SEG</div>
        </div>
      </div>
